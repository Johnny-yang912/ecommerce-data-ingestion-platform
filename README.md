...
Every push to `main` and every Pull Request automatically triggers GitHub Actions (`.github/workflows/ci.yml`), which installs dependencies and runs the full test suite (381 tests, 100% coverage of the gated modules) across a **Python 3.10 and 3.12** matrix.
