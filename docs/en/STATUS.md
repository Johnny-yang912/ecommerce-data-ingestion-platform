...
| CI does not exercise DB-layer contracts | A green check does not mean CAS/dedup/migration are verified | Manual scripts: `scripts/load_test.py`, `check_migration_drift.py`; post-crash recovery is recorded in [verification/2026-08-10-celery-sigkill-recovery](./verification/2026-08-10-celery-sigkill-recovery.md) |
