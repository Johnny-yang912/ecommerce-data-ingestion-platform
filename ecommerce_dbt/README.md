...
- ✅ `rpt_quality_events_daily.promotions` has been populated with real values by v3's first retroactive re-evaluation (2026-08-05: 15 records). `re_quarantines` is still 0 — it needs a re-evaluation after a **tightening**, and no such scenario exists yet (see [ORCHESTRATION §5.1](../ORCHESTRATION.md))
