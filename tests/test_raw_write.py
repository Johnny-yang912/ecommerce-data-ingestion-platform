...
class TestRawWriteRetry:
    ...
    async def test_no_error_commits_once(self, mock_request, sample_order):
    ...
    async def test_retry_succeeds_on_second_attempt(self, mock_request, sample_order):
    ...
    async def test_all_retries_exhausted_raises_operational_error(self, mock_request, sample_order):
